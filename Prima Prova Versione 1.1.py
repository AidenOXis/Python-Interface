...
class IsulinometroApp(tk.Tk):
    ...
    def create_data_frame(self):
        ...
        lower_left_frame.columnconfigure(2, weight=1)

        # Buttons inside the lower left frame
        reset_button = tk.Button(lower_left_frame, text="RESET", bg="purple", height=2)
        reset_button.grid(column=0, row=0, padx=5, pady=5, sticky="nesw")
        
        stop_button = tk.Button(lower_left_frame, text="STOP", bg="red", height=2)
        stop_button.grid(column=1, row=0, padx=5, pady=5, sticky="nesw")
        
        save_button = tk.Button(lower_left_frame, text="SAVE", bg="lightblue", height=2)
        save_button.grid(column=2, row=0, padx=5, pady=5, sticky="nesw")
