...
class MyService(dbus.service.Object):
    def __init__(self, bus, uuid):
        ...
        self.path = f"/test/service/{uuid}"  # Use the UUID directly as part of the path
        super().__init__(bus, self.path)
        self.uuid = uuid
        self.characteristics = []
        self.bus = bus  # Initialize bus here
...
class MyCharacteristic(dbus.service.Object):
    def __init__(self, bus, service, uuid, mode):
        ...
        self.path = f"{service.path}/char_{uuid}"  # Use the UUID directly as part of the path
        super().__init__(bus, self.path)
