...
class IsulinometroApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.ascissa = 0
        self.valori_ascissa = []
        self.valori_ordinata = []

        # Configurazione del grafico
        self.fig, self.ax = plt.subplots()
        self.ax.set_title("Andamento Resistenza")
        self.ax.set_xlabel("Ascissa")
        self.ax.set_ylabel("Resistenza (Ohm)")
    ...
    def create_home_frame(self):
        ...
        #start_button = tk.Button(self, text="START", command=self.start_button_click)
